...
namespace Infrastructure.Data
{
    public static class StoreContextSeed
    {
        public static async Task SeedAsync(StoreContext context)
        {
            ...
            var p9 = new Product() { Name = "Sephora Rouge Lacquer Lipstick", Price = 249.90m, PictureUri = "09.jpg", Brand = se, Category = ls };
            ...
            var p11 = new Product() { Name = "L'Oreal Paris Color Riche Lipstick (Valentine's Day Special)", Price = 54.94m, PictureUri = "11.jpg", Brand = lp, Category = ls };
